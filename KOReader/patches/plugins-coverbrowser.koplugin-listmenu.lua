...
function ListMenuItem:update()
    ...
    if self.is_directory then
        ...
        if bookinfo then -- This book is known
            ...
            local wmain_width = dimen.w - wleft_width - wmain_left_padding - wmain_right_padding
            if #wright_items > 1 then
                wmain_width = wmain_width - wright_width - wright_right_padding
            end
            ...
            local wtitle, wauthors, tbwauthors
            ...
            local build_authors = function(height)
                ...
                local wauthor_width = wmain_width
                if #wright_items == 1 then
                    wauthor_width = wmain_width - wright_width - wright_right_padding
                end
                tbwauthors = TextBoxWidget:new{
                    text = authors,
                    lang = bookinfo.language,
                ...
                if #wright_items == 1 then
                    local mdimen = Geom:new{ w = wmain_width, h = tbwauthors:getSize().h }
                    wauthors = OverlapGroup:new{
                        dimen = mdimen:copy(),
                        LeftContainer:new{
                            dimen = mdimen:copy(),
                            -- HorizontalGroup:new{
            ...
            while true do
                ...
                if fixed_font_size or fontsize_title <= 12 or fontsize_authors <= 10 then
                    ...
                    local authors_line_height = authors and tbwauthors:getLineHeight() or 0
            ...
            -- add right widget
            -- if wright then
            if #wright_items > 1 or wauthors == nil then
