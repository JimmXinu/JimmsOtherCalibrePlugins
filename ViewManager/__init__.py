...
class ActionViewManager(InterfaceActionBase):
    '''
    ...
    actual_plugin           = 'calibre_plugins.view_manager.action:ViewManagerAction'
    ...
    def config_widget(self):
        ...
        '''
        from calibre_plugins.view_manager.config import ConfigWidget
