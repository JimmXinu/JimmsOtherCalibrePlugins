...
if sys.version_info >= (2, 7):
    ...
    loghandler.setFormatter(logging.Formatter("CopyToLibrary: %(levelname)s: %(asctime)s: %(filename)s(%(lineno)d): %(message)s"))
...
class CopyToLibraryBase(InterfaceActionBase):
    '''
    ...
    CopyToLibraryPlugin and is defined in the copytolibrary_plugin.py file, as
    ...
    actual_plugin       = 'calibre_plugins.copytolibrary.copytolibrary_plugin:CopyToLibraryPlugin'
    ...
    def config_widget(self):
        ...
        from calibre_plugins.copytolibrary.config import ConfigWidget
