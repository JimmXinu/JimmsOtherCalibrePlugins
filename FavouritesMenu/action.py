...
from calibre_plugins.favourites_menu.common_utils import (set_plugin_icon_resources,
                                            get_icon, create_menu_action_unique)
...
class FavouritesMenuAction(InterfaceAction):
    ...
    action_spec = ('Favourites', None, None, None)
